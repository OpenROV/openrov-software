(function (window, $) {
    ...
    rov.cockpit.extensionPoints.inputController.register(
      [
        ...
        // Up / Forward
        {
          ...
          up: function () {
            rov.cockpit.rov.emit('plugin.rovpilot.setThrottle', 0);
          }
        },
        ...
        // left
        {
          ...
          up: function () {
            rov.cockpit.rov.emit('plugin.rovpilot.setYaw', 0);
          }
        },
        ...
        // Lift up
        {
          ...
          up: function () {
            rov.cockpit.rov.emit('plugin.rovpilot.setLift', 0);
          }
        },
        // Push down
        {
  ...
  ROVpilot.prototype.listen = function listen() {
    ...
    rov.cockpit.rov.emit('plugin.rovpilot.powerLevel.request');
  };
